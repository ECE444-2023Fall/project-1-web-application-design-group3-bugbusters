...
if [[ $1 = "build" ]]; then
    docker compose -f docker-compose-release.yaml build ${SERVICE}
elif [[ $1 = "up" ]]; then
    docker compose -f docker-compose-release.yaml up ${SERVICE}
elif [[ $1 = "down" ]]; then
    docker compose -f docker-compose-release.yaml down ${SERVICE}
fi
